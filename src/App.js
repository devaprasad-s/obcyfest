  ...
  return (
    <div id="home"className="container">
      <header>
        ...
        <section className= "obcy-head"><h1>{text}</h1></section>
        {/* Add more content, event details, and sections as needed */}
      </header>
      <section className="mascot-introduction">
        <h2>Our Mascots</h2>
        <p>
        Meet our lovable mascots, each with a unique personality and incredible talents. These four extraordinary creatures are the heart and soul of Obcyfest 2023, and they can't wait to share their stories with you.
        </p>
      </section>
      <section className="mascots">
      <div className="mascot">
          <img src={Mascot1} alt="Mascot 1" />
          <h2>Raptorix</h2><p className="explanation"><p>I am Raptorix, the first year mascot. I love to fly high and hack into new domains. Learning and exploring are my passions. I am always up for some fun and friendship, but don’t underestimate me. I can be fierce and competitive when it comes to achieving my goals.</p></p>
        </div>
        <div className="mascot">
          <img src={Mascot2} alt="Mascot 2" />
          <h2>Metalix</h2><p className="explanation"><p> I am Metalix, the second year mascot. I love to transform myself and engineer new solutions. Creating and improving are my skills. I am cool and confident in what I do, but I also value loyalty and support. I can be a great ally and a reliable partner.</p></p>
        </div>
        <div className="mascot">
          <img src={Mascot3} alt="Mascot 3" />
          <h2>Blackspix</h2><p className="explanation"><p>I am Blackspix, the third year mascot. I love to challenge myself and overcome any obstacle. Challenging and overcoming are my strengths. I am bold and charismatic in my actions, but I also respect humility and gratitude. I can be a leader and a role model for others.</p></p>

        </div>
        <div className="mascot">
          <img src={Mascot4} alt="Mascot 4" />
          <h2>Wyrmix</h2><p className="explanation"><p>I am Wyrmix, the fourth year mascot. I love to lead with wisdom and inspire with magic. Leading and inspiring are my gifts. I am noble and majestic in my presence, but I also care for kindness and generosity. I can be a mentor and a guardian for all.</p></p>
      ...
      <section className="events-intro">
        <h2>Our Events</h2>
        <p>
        Take a look at our various events for this year's Obcyfest 2k23.
        </p>
      </section>
      <section className="event-posters">
  {events.map((event, index) => (
    <div className="poster" key={index}>
      <img src={event.poster} alt={`Event Poster ${index}`} onClick={() => openEventDetails(event)} />
      <h3>{event.title}</h3>
    </div>
  ))}
</section>
